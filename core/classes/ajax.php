...
/**
 * Returns the folder ID from a folder path
 *
 * Examples: 
 * Path lookup: /Workspace/ => 101
 * Anchor lookup: ^home_username1 => /Workspace/Personal folders/username1 => 11701
 * Module lookup: !sys_users => 11501
 * Anchor + path lookup: ^home_username1/Tasks => /Workspace/Personal folders/username1/Tasks => 12301
 * Anchor + module lookup: ^home_username1/!tasks => /Workspace/Personal folders/username1/Tasks => 12301
 * Path + module lookup: /Workspace/Demo/!tasks => /Workspace/Demo/Tasks => 2201
 * 
 * @param string $path Folder string (/Workspace/.../)
 * @return int Folder ID, 0 if not found
 */
static function folder_from_path($path) {
