...
<body class="body">
  ...
  <table id="wikimid" width="100%" cellspacing="0" cellpadding="0"><tr>
    <td id="wikileft" valign="top">
	  <p style="text-align: right; font-size:83%;">- <a target="_blank" href="<?= SELF ?>/Site.SideBar?edit">{t}Edit{/t}</a> -</p>
  ...
  <div id="wikifoot">
    <div class="footnav">
	  <span style="float:right;">{t}Page last modified on{/t} <?= modify::localdateformat($this->page["lastmodified"],"{t}F j, Y{/t}") ?>&nbsp;</span>
